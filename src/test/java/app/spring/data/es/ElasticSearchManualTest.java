...
import app.spring.data.es.config.Config;
import app.spring.data.es.model.Article;
import app.spring.data.es.model.Author;
import app.spring.data.es.repository.ArticleRepository;
